...
The v0.3.2.4 development source adds automatic notifications through the existing
...
The current release is **v0.3.2.4 LiveBubbles**, based on v0.3.2.3. Builds from v0.1.6.0 through v0.1.9.9
